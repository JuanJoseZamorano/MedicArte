...
\restrict Z7wf6MNwSfKneDgcvNrzpjoUJyN4ZFh6AIXlOntywnv6JVZD9251CkkvbypIsKn
...
ALTER TABLE IF EXISTS ONLY medicarte.usuario DROP CONSTRAINT IF EXISTS usuario_id_medico_fkey;
ALTER TABLE IF EXISTS ONLY medicarte.medico DROP CONSTRAINT IF EXISTS medico_id_especialidad_fkey;
ALTER TABLE IF EXISTS ONLY medicarte.log_accion DROP CONSTRAINT IF EXISTS log_accion_id_usuario_fkey;
ALTER TABLE IF EXISTS ONLY medicarte.historia_clinica DROP CONSTRAINT IF EXISTS historia_clinica_id_paciente_fkey;
ALTER TABLE IF EXISTS ONLY medicarte.episodio DROP CONSTRAINT IF EXISTS episodio_id_historia_fkey;
ALTER TABLE IF EXISTS ONLY medicarte.episodio DROP CONSTRAINT IF EXISTS episodio_id_especialidad_fkey;
ALTER TABLE IF EXISTS ONLY medicarte.consulta DROP CONSTRAINT IF EXISTS consulta_id_medico_fkey;
ALTER TABLE IF EXISTS ONLY medicarte.consulta DROP CONSTRAINT IF EXISTS consulta_id_episodio_fkey;
ALTER TABLE IF EXISTS ONLY medicarte.consulta DROP CONSTRAINT IF EXISTS consulta_id_cita_fkey;
ALTER TABLE IF EXISTS ONLY medicarte.cita DROP CONSTRAINT IF EXISTS cita_id_paciente_fkey;
ALTER TABLE IF EXISTS ONLY medicarte.cita DROP CONSTRAINT IF EXISTS cita_id_medico_fkey;
DROP INDEX IF EXISTS medicarte.idx_usuario_medico;
DROP INDEX IF EXISTS medicarte.idx_historia_paciente;
DROP INDEX IF EXISTS medicarte.idx_epi_historia;
DROP INDEX IF EXISTS medicarte.idx_epi_especialidad;
DROP INDEX IF EXISTS medicarte.idx_consulta_medico;
DROP INDEX IF EXISTS medicarte.idx_consulta_episodio;
DROP INDEX IF EXISTS medicarte.idx_cita_paciente;
DROP INDEX IF EXISTS medicarte.idx_cita_medico;
DROP INDEX IF EXISTS medicarte.idx_cita_fecha;
ALTER TABLE IF EXISTS ONLY medicarte.usuario DROP CONSTRAINT IF EXISTS usuario_pkey;
ALTER TABLE IF EXISTS ONLY medicarte.usuario DROP CONSTRAINT IF EXISTS uq_usuario_username;
ALTER TABLE IF EXISTS ONLY medicarte.historia_clinica DROP CONSTRAINT IF EXISTS uq_historia_paciente;
ALTER TABLE IF EXISTS ONLY medicarte.paciente DROP CONSTRAINT IF EXISTS paciente_pkey;
ALTER TABLE IF EXISTS ONLY medicarte.medico DROP CONSTRAINT IF EXISTS medico_pkey;
ALTER TABLE IF EXISTS ONLY medicarte.log_accion DROP CONSTRAINT IF EXISTS log_accion_pkey;
ALTER TABLE IF EXISTS ONLY medicarte.historia_clinica DROP CONSTRAINT IF EXISTS historia_clinica_pkey;
ALTER TABLE IF EXISTS ONLY medicarte.especialidad DROP CONSTRAINT IF EXISTS especialidad_pkey;
ALTER TABLE IF EXISTS ONLY medicarte.episodio DROP CONSTRAINT IF EXISTS episodio_pkey;
ALTER TABLE IF EXISTS ONLY medicarte.consulta DROP CONSTRAINT IF EXISTS consulta_pkey;
ALTER TABLE IF EXISTS ONLY medicarte.configuracion DROP CONSTRAINT IF EXISTS configuracion_pkey;
ALTER TABLE IF EXISTS ONLY medicarte.cita DROP CONSTRAINT IF EXISTS cita_pkey;
ALTER TABLE IF EXISTS medicarte.usuario ALTER COLUMN id_usuario DROP DEFAULT;
ALTER TABLE IF EXISTS medicarte.paciente ALTER COLUMN id_paciente DROP DEFAULT;
ALTER TABLE IF EXISTS medicarte.medico ALTER COLUMN id_medico DROP DEFAULT;
ALTER TABLE IF EXISTS medicarte.log_accion ALTER COLUMN id_log DROP DEFAULT;
ALTER TABLE IF EXISTS medicarte.historia_clinica ALTER COLUMN id_historia DROP DEFAULT;
ALTER TABLE IF EXISTS medicarte.especialidad ALTER COLUMN id_especialidad DROP DEFAULT;
ALTER TABLE IF EXISTS medicarte.episodio ALTER COLUMN id_episodio DROP DEFAULT;
ALTER TABLE IF EXISTS medicarte.consulta ALTER COLUMN id_consulta DROP DEFAULT;
ALTER TABLE IF EXISTS medicarte.cita ALTER COLUMN id_cita DROP DEFAULT;
DROP SEQUENCE IF EXISTS medicarte.usuario_id_usuario_seq;
DROP TABLE IF EXISTS medicarte.usuario;
DROP SEQUENCE IF EXISTS medicarte.paciente_id_paciente_seq;
DROP TABLE IF EXISTS medicarte.paciente;
DROP SEQUENCE IF EXISTS medicarte.medico_id_medico_seq;
DROP TABLE IF EXISTS medicarte.medico;
DROP SEQUENCE IF EXISTS medicarte.log_accion_id_log_seq;
DROP TABLE IF EXISTS medicarte.log_accion;
DROP SEQUENCE IF EXISTS medicarte.historia_clinica_id_historia_seq;
DROP TABLE IF EXISTS medicarte.historia_clinica;
DROP SEQUENCE IF EXISTS medicarte.especialidad_id_especialidad_seq;
DROP TABLE IF EXISTS medicarte.especialidad;
DROP SEQUENCE IF EXISTS medicarte.episodio_id_episodio_seq;
DROP TABLE IF EXISTS medicarte.episodio;
DROP SEQUENCE IF EXISTS medicarte.consulta_id_consulta_seq;
DROP TABLE IF EXISTS medicarte.consulta;
DROP TABLE IF EXISTS medicarte.configuracion;
DROP SEQUENCE IF EXISTS medicarte.cita_id_cita_seq;
DROP TABLE IF EXISTS medicarte.cita;
DROP SCHEMA IF EXISTS medicarte;
--
...
CREATE TABLE medicarte.cita (
    ...
    CONSTRAINT chk_cita_origen CHECK (((origen)::text = ANY ((ARRAY['CLINICA'::character varying, 'APP'::character varying])::text[])))
);
...
CREATE TABLE medicarte.consulta (
    ...
    CONSTRAINT chk_consulta_estado CHECK (((estado)::text = ANY ((ARRAY['BORRADOR'::character varying, 'FINALIZADA'::character varying])::text[])))
);
...
CREATE TABLE medicarte.episodio (
    ...
    CONSTRAINT chk_episodio_estado CHECK (((estado)::text = ANY ((ARRAY['ABIERTO'::character varying, 'CERRADO'::character varying])::text[])))
);
...
CREATE TABLE medicarte.historia_clinica (
    ...
    notas text,
    CONSTRAINT chk_historia_estado CHECK (((estado)::text = ANY ((ARRAY['ACTIVA'::character varying, 'CERRADA'::character varying])::text[])))
);
...
24	2	1	2026-02-04 21:50:58.652208	PENDIENTE	CLINICA	Expedicion de medicamentos	10
...
9	antonio	$2a$10$Kto02vTSAiufET/gh9utCugx4Gpdsy/6X97YNd1ilMBBJ0JzOdyX2	ADMIN	\N	t
\.
...
SELECT pg_catalog.setval('medicarte.consulta_id_consulta_seq', 21, true);
...
\unrestrict Z7wf6MNwSfKneDgcvNrzpjoUJyN4ZFh6AIXlOntywnv6JVZD9251CkkvbypIsKn
