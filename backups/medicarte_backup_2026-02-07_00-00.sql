...
\restrict dgm0HYHQgHSq5OcAJg9PSxT3GSkC8QjJhESSCgGecg14jhq0ifGUKYa3j71MFmU
...
25	2	1	2026-02-04 21:51:22.220333	CANCELADA	CLINICA	Expedicion de medicamentos	10
26	7	2	2026-02-04 09:00:00	COMPLETADA	CLINICA	cita de prueba	\N
27	6	1	2026-02-04 09:00:00	COMPLETADA	CLINICA	viene por quele duele la cabeza	\N
28	10	1	2026-02-04 11:00:00	COMPLETADA	CLINICA	esta muje es mu pesa	\N
29	10	1	2026-02-04 22:00:00	CANCELADA	CLINICA		\N
31	6	1	2026-02-03 09:00:00	COMPLETADA	CLINICA	dddddd	\N
30	10	1	2026-02-05 09:00:00	CANCELADA	CLINICA	ddddddddddddd	\N
33	8	1	2026-03-02 09:00:00	PENDIENTE	CLINICA	cambia la cita para antes	\N
32	8	1	2026-05-23 11:00:00	CANCELADA	CLINICA	nueva cita para mayo	\N
35	1	1	2026-02-06 09:00:00	CANCELADA	CLINICA	cienana	\N
36	4	4	2026-02-09 09:00:00	CANCELADA	CLINICA	dolor de cabeza	\N
34	1	1	2026-02-06 09:00:00	CANCELADA	CLINICA	cienana	\N
37	3	1	2026-02-07 11:00:00	PENDIENTE	CLINICA	Revision de próstata	\N
38	10	1	2026-02-12 09:00:00	PENDIENTE	CLINICA	dfgbdftgbftgb	\N
39	10	3	2026-02-11 09:00:00	PENDIENTE	CLINICA	qqqqqqq	\N
40	7	1	2026-02-07 09:45:00	PENDIENTE	CLINICA	nueva cita con hora de hora y minutos de duracion	\N
41	6	2	2026-02-27 10:00:00	PENDIENTE	CLINICA	opnce minuto para uan nueva cita	11
42	6	4	2026-02-12 09:45:00	PENDIENTE	CLINICA	32 minutos	32
\.
...
ULTIMA_FECHA_BKP	6 de febrero de 2026. 21:31
\.
...
23	10	1	26	2026-02-04 09:00:00	asdasdasd	asdasdasdasd	dasda	asdas	\N	asdasd	asd	FINALIZADA
24	11	1	27	2026-02-04 09:00:00	Se ha roto un bracito	le duele al palparla	tiene sangre en los dedos	brazo roto	\N	ibuprofeno	estaba muy nerviosa	FINALIZADA
25	8	1	28	2026-02-04 11:00:00	ya no le duele. LE doy el alta	werfwefwef	wefewf	wefwef	\N	wefwefwe	fwefwefwef	FINALIZADA
26	11	1	31	2026-02-03 09:00:00	cierro consulta pq noi ha venidso	na	na	na	\N	na	na	FINALIZADA
\.
...
10	8	1	asdasdasd	2026-02-04	\N	ABIERTO
11	9	2	Se ha roto un bracito	2026-02-04	\N	ABIERTO
\.
...
8	7	2026-02-04	ACTIVA	\N
9	6	2026-02-04	ACTIVA	\N
\.
...
4	Ayxa Sepúlveda Troya	080910	1	t
\.
...
1	12345678A	Juan	Pérez López	1985-05-10	Hombre	600123456	juan.perez@email.com	Calle Mayor 12	Sevilla	41001	Sanitasss	SAN12345	NUHSA001	NUSS001	NHC001	O+	No presenta alergias medicamentosas conocidas.	Hipertensión arterial controlada desde 2018. Episodios esporádicos de migraña.	Padre con diabetes tipo II. Madre con hipertensión.	Enalapril 20mg diarios.	2025-12-28 23:18:53.816143	data\\fotos\\paciente_1.png
...
10	Ayxa	$2a$10$WlFajMIry4B2KN2RksQhmeJoDnQr4N.4.qGF2QdWB62.7rIZg/1Ly	MEDICO	4	t
\.
...
SELECT pg_catalog.setval('medicarte.cita_id_cita_seq', 42, true);
...
SELECT pg_catalog.setval('medicarte.consulta_id_consulta_seq', 26, true);
...
SELECT pg_catalog.setval('medicarte.episodio_id_episodio_seq', 11, true);
...
SELECT pg_catalog.setval('medicarte.historia_clinica_id_historia_seq', 9, true);
...
SELECT pg_catalog.setval('medicarte.medico_id_medico_seq', 4, true);
...
SELECT pg_catalog.setval('medicarte.paciente_id_paciente_seq', 19, true);
...
\unrestrict dgm0HYHQgHSq5OcAJg9PSxT3GSkC8QjJhESSCgGecg14jhq0ifGUKYa3j71MFmU
